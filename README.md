...
<div align="center">
<img src="./src/assets/img/readme-logo.png" alt="logo" width="360">
<br>
Rick and Morty Card Memory Game
<br>
<br>
  <p>
    <a href="https://rickandmorty-memory-teal.vercel.app/">View Demo</a>
    &nbsp;·&nbsp;
    <a href="https://github.com/stefanbrkic1/MemoryGame/issues">Report Bug</a>
    &nbsp;·&nbsp;
    <a href="https://github.com/stefanbrkic1/MemoryGame/issues">Request Feature</a>
  </p>
...
Embark on an interdimensional memory adventure with the Rick and Morty Card Memory Game! Immerse yourself in the chaotic and hilarious world of Rick Sanchez and his grandson Morty as you flip cards to match iconic characters, objects, and scenes from the multiverse. Challenge your memory skills, explore parallel dimensions, and experience the whimsical charm of Rick and Morty. Uncover pairs, avoid the portal mishaps, and revel in the unpredictable fun of this entertaining card-matching extravaganza. Get ready to shuffle through dimensions and test your memory in a way that's uniquely Rick and Morty! 🚀🃏🌀
